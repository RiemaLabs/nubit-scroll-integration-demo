...
import (
	...
	"github.com/RiemaLabs/nubit-validator/utils/tk/sh/mint"
	mintkeeper "github.com/RiemaLabs/nubit-validator/utils/tk/sh/mint/keeper"
	minttypes "github.com/RiemaLabs/nubit-validator/utils/tk/sh/mint/types"
	...
	"github.com/RiemaLabs/nubit-validator/auxiliary/encoding"
	proof "github.com/RiemaLabs/nubit-validator/pf"
	"github.com/RiemaLabs/nubit-validator/utils/appconsts"
	"github.com/RiemaLabs/nubit-validator/utils/tk/paramfilter"
	blobmodule "github.com/RiemaLabs/nubit-validator/utils/tk/sh/blob"
	blobmodulekeeper "github.com/RiemaLabs/nubit-validator/utils/tk/sh/blob/keeper"
	blobmoduletypes "github.com/RiemaLabs/nubit-validator/utils/tk/sh/blob/types"
	"github.com/RiemaLabs/nubit-validator/utils/tk/tokenfilter"
	appupgrade "github.com/RiemaLabs/nubit-validator/utils/tk/upgrade"

	ibctestingtypes "github.com/cosmos/ibc-go/v6/testing/types"
)

const (
	AccountAddressPrefix = "nubit"
	Name                 = "nubit-validator"
	// BondDenom defines the native staking token denomination.
	BondDenom = appconsts.BondDenom
	// BondDenomAlias defines an alias for BondDenom.
	BondDenomAlias = "micronub"
	// DisplayDenom defines the name, symbol, and display value of the Nubit token.
	DisplayDenom = "NUB"
)
...
func init() {
	userHomeDir := os.Getenv("NUBIT_HOME")
...
type App struct {
	*baseapp.BaseApp
	...
	// for cached latest btc block height
	LatestBtcHeight            uint64
	LatestBtcHeightNotRecorded bool
}

// New returns a reference to an initialized nubit app.
func New(
	logger log.Logger,
	db dbm.DB,
	...
	app.BTCRpc = cast.ToString(appOpts.Get(server.FlagBTCRpc))
	...
	app.LatestBtcHeightNotRecorded = true
	app.LatestBtcHeight = 0
...
/*
func (a *App) updateLatestBtcHeight() error {
	_height, err = a.btcRef.fetchHeight()
	if err != nil {
		return err
	}
	if a.LatestBtcHeightNotRecorded {
		a.LatestBtcHeightNotRecorded = false
		a.LatestBtcHeight = _height
	}
	return nil
}
*/
